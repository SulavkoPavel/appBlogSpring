package ru.sulavko.blog.conntrollers;
...
import ru.sulavko.blog.repo.PostRepository;
...
public class BlogController {
    ...
    public String blogMain(Model model) {
        model.addAttribute("titel", "Блог сайта");
    ...
    public String blogAdd(Model model) {
        model.addAttribute("titel", "Добавление статьи");
        return "blog-add";
    }
